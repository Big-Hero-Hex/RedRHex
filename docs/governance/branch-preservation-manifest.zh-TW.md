...
從清單記錄的 `archive/*` ref 復原歷史工作，不可移動 `main`。已驗證的本機 bundle 是 `.worktrees/branch-reorg-recovery-2026-08-13.bundle`，SHA-256 為 `fbb10c25f87c87fa34c7360c2baf73508c6d31d3c38ffef5d3a3c50250bf86d2`。Final published audit 完成前保留此檔。
