...
- [2026-08-01 扭轉彈簧 V11 暫定 checkpoint](2026-08-01-torsion-spring-v11-checkpoint.zh-TW.md)
...
原始 logs 與 run notes 不進入 canonical documentation。只有在經審查證據改變 baseline、recommendation、decision 或 published result 時，才提交雙語 experiment summary。已發布摘要不可變；修正使用 dated addenda。
