...
Primary code evidence is in `source/RedRhex/RedRhex/tasks/direct/redrhex/redrhex_env.py`, `source/RedRhex/RedRhex/tasks/direct/redrhex/redrhex_env_cfg.py`, `source/RedRhex/RedRhex/tasks/direct/redrhex/agents/sensor_v2/backends.py`, `scripts/rsl_rl/train.py`, `scripts/rsl_rl/train_sensor_v2_pipeline.py`, `ros2_ws/src/redrhex_rl_controller/redrhex_rl_controller/observation_builder.py`, `ros2_ws/src/redrhex_rl_controller/redrhex_rl_controller/policy_onnx_runner.py`, `ros2_ws/src/redrhex_lowlevel_bridge/redrhex_lowlevel_bridge/rinbo_ros_backend.py`, and `tools/sim2real/import_real.py`. The recovered Panel paths are evidence for the stacked proposal, not this core branch.
